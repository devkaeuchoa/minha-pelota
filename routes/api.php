...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::patch('groups/{group}/players/{player}', [GroupPlayerController::class, 'update'])
        ->name('api.groups.players.update');
    Route::delete('groups/{group}/players/{player}', [GroupPlayerController::class, 'destroy'])
